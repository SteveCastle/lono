...
const S = {
  ...
  subtab: { types: 'entityTypes', cast: 'entities', systems: 'triggers' },
  pt: null, ptSeed: 42,
};

const SECTIONS = [
  ['game', 'Game'], ['world', 'World'], ['types', 'Types'], ['cast', 'Cast'],
  ['story', 'Story'], ['beats', 'Beats'], ['systems', 'Systems'], ['lore', 'Lore'], ['json', 'JSON'],
];
...
function renderMain() {
  ...
  ({ game: renderGame, world: renderWorld, types: renderTypes, cast: renderCast, story: renderStory, beats: renderBeats, systems: renderSystems, lore: renderLore, json: renderJSON }[S.section])(main);
}
